...
namespace ExampleSQLApp.hostelDataSetTableAdapters {
    ...
    public partial class adminsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ExampleSQLApp.Properties.Settings.Default.hostelConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `user`, `password` FROM `admins`";
        ...
        public virtual int Fill(hostelDataSet.adminsDataTable dataTable) {
        ...
        public virtual hostelDataSet.adminsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hostelDataSet.adminsDataTable dataTable = new hostelDataSet.adminsDataTable();
